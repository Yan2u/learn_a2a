...
class UserExecutor(AgentExecutor):
    ...
    image_descriptor_client: A2AClient | None = None
    speech2text_client: A2AClient | None = None
    image_descriptor_httpx: httpx.AsyncClient | None = None
    speech2text_httpx: httpx.AsyncClient | None = None
    ...
    async def image_desc(self, updater: TaskUpdater, context: RequestContext, prompt: str, img_bytes: str):
        ...
        try:
            ...
            print(f"[User] Error during image description: {e}", flush=True)
